export type ConsoleSystem = 'mame' | 'retroarch' | 'ps2' | 'gamecube' | 'wii' | 'naomi' | 'model2' | 'saturn';
...
export interface EmulatorProfile {
  ...
  videoPipeline: 'Groovy_MiSTer D3D9' | 'Groovy_MiSTer Vulkan' | 'SwitchRes Direct' | 'Raw Framebuffer UDP' | 'Groovy_MiSTer SwitchRes 15kHz Direct' | 'RetroArch CRT SwitchRes 15kHz' | 'Experimental Video Bridge';
